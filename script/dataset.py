...
class UCF101_Data(pl.LightningDataModule):
    def __init__(self, data, clip_len, frame_sample_rate, batch_size, num_workers):
        super().__init__()
        self.data = data
    ...
    def setup(self, stage):
        self.train_data = VideoDataset(
            directory=self.data,
            mode='train',
            clip_len=self.clip_len,
            frame_sample_rate=self.frame_sample_rate,
        )
        self.val_data = VideoDataset(
            directory=self.data,
            mode='validation',
            clip_len=self.clip_len,
            frame_sample_rate=self.frame_sample_rate,
...
class VideoDataset(Dataset):
    ...
    def __init__(self, directory, mode='train', clip_len=8, frame_sample_rate=1):
        ...
        folder = os.path.join(directory, mode)
        self.clip_len = clip_len
